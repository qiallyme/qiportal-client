            ...
            <div className="space-y-3">
              <button className="w-full flex items-center justify-between p-4 bg-white/5 rounded-xl hover:bg-white/10 transition-colors">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium text-white">Add New Client</span>
                </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="font-medium text-white">New client added</p>
                  <p className="text-sm text-gray-400">Acme Corp joined the platform</p>
                </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl">
                ...
                <div className="flex-1">
                  <p className="font-medium text-white">Project completed</p>
                  <p className="text-sm text-gray-400">E-commerce site launched</p>
                </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/5 rounded-xl">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-gray-400">Invoice #1234 paid</p>
                </div>
