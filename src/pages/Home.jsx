          ...
          <div className="container mx-auto max-w-6xl">
            <div className="glass-card p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                {/* Industries List */}
                <div className="glass-card p-6 border border-magenta-500/20">
                  <h4 className="text-xl font-semibold mb-4 text-magenta-300">Industries</h4>
                  <ul className="space-y-3 text-gray-300">
                    {whatWeOffer.industries.map((industry, index) => (
                      <li key={index} className="flex items-start">
                        <svg className="w-5 h-5 text-magenta-400 mr-3 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                        </svg>
                        <span>{industry}</span>
                      </li>
                ...
                {/* Expertise List */}
                <div className="glass-card p-6 border border-electric-blue-500/20">
                  <h4 className="text-xl font-semibold mb-4 text-electric-blue-300">Expertise</h4>
                  <ul className="space-y-3 text-gray-300">
